    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tMain1 = '{preview}\n' +
                ...
                '</div>';
            tMain2 = '{preview}\n<div class="kv-upload-progress hide"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n';
            tPreview = '<div class="file-preview {class} box-body">\n' +
                '    {close}' +
                '    <div class="{dropClass}">\n' +
            ...
            tBtnDefault = '<button type="{type}" tabindex="500" title="{title}" class="{css} btn-flat btn-sm" ' +
                '{status}>{icon} {label}</button>';
            //noinspection HtmlUnknownAttribute
            tBtnLink = '<a href="{href}" tabindex="500" title="{title}" class="{css} btn-flat btn-sm" {status}>{icon} {label}</a>';
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<div tabindex="500" class="{css} btn-sm" {status}>{icon} {label}</div>';
            ...
            tActions = '{drag}\n' +
                ...
                '       {delete} ' +
                '       {zoom} {other}' +
                //'       <button type="button" class="btn btn-flat btn-primary btn-xs">Add Content</button>'+
                '    </div>\n' + 
                '    <div class="clearfix"></div>\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<button type="button" class="kv-file-remove btn-flat {removeClass}" ' +
                'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
            tActionUpload = '<button type="button" class="kv-file-upload btn-flat {uploadClass}" title="{uploadTitle}">' +
                '{uploadIcon}</button>';
            tActionZoom = '<button type="button" class="kv-file-zoom hidden {zoomClass}" ' +
                'title="{zoomTitle}">{zoomIcon}</button>';
            tActionDrag = '<span class="file-drag-handle {dragClass} hidden" title="{dragTitle}">{dragIcon}</span>';
