    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="js-data-container">
                @include('control_panel.class_rooms.partials.data_list')
            </div>
        </div>
    </div>
@endsection
...
@section ('scripts')
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "{{ route('admin.maintenance.classrooms') }}",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            $('body').on('click', '#js-button-add, .js-btn_update_sy', function (e) {
                ...
                var id = $(this).data('id');
                $.ajax({
                    url : "{{ route('admin.maintenance.classrooms.modal_data') }}",
                    type : 'POST',
            ...
            $('body').on('submit', '#js-form_subject_details', function (e) {
                ...
                $.ajax({
                    url         : "{{ route('admin.maintenance.classrooms.save_data') }}",
                    type        : 'POST',
                    data        : formData,
                    processData : false,
                    contentType : false,
