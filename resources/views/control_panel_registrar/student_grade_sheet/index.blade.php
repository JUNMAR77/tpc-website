    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="js-data-container">
                {{--  @include('control_panel_registrar.student_grade_sheet_details.partials.data_list')  --}}
            </div>
        </div>
...
@section ('scripts')
    ...
    <script>
        ...
        function fetch_data () {
            ...
            loader_overlay();
            $.ajax({
                url : "{{ route('registrar.student_grade_sheet.list_students_by_class') }}",
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(function () {
            ...
            $('body').on('change', '#search_sy', function () {
                $.ajax({
                    url : "{{ route('registrar.student_grade_sheet.list_class_subject_details') }}",
                    type : 'POST',
                    {{--  dataType    : 'JSON',  --}}
